    ...
    <form method="POST"
        ...
        <div class="px-6 py-24 xl:px-96 space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h1 class="text-lg mb-12 font-semibold leading-7 text-gray-900">Edit Product - <span
                        class="font-bold text-black">{{ $product->name }}</span></h1>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        <label for="category" class="block text-sm font-medium leading-6 text-gray-900">Product
                            category</label>
                        <div class="mt-2">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                class="flex rounded-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input type="text" name="name" id="name" autocomplete="name"
                                    class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    value="{{ $product->name }}"
                                    placeholder="Château Palmer, Gaja Barbaresco, Highland Park 25 Yr...">
                            </div>
                        </div>
                        @error('name')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div class="relative mt-2 shadow-sm">
                            ...
                            <div
                                ...
                                <input type="text" name="price" id="price"
                                    class="block flex-1 border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    ...
                    <div class="col-span-full">
                        <label for="cover" class="block text-sm font-medium leading-6 text-gray-900 pb-8">Product
                            photo</label>
                        ...
                        <img src="{{ $product->image ? asset('storage/' . $product->image) : asset('/images/small-logo.png') }}"
                            alt="{{ $product->name }}" class="h-64 object-cover">
                        @error('cover')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                            <div
                                class="flex rounded-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input type="text" name="brand" id="brand" autocomplete="brand"
                                    class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                    ...
                    <div class="col-span-6 xl:col-span-2">
                        <label for="alcohol_vlm" class="block text-sm font-medium leading-6 text-gray-900">Alcohol
                            volume</label>
                        <div class="relative mt-2 shadow-sm">
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                <span class="text-gray-500 sm:text-sm">%</span>
                            ...
                            <div
                                class="flex-1 rounded-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input type="text" name="alcohol_vlm" id="alcohol_vlm"
                                    class="block w-full border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    ...
                    <!-- product size -->
                    <div class="col-span-6 xl:col-span-2">
                        <label for="size" class="block text-sm font-medium leading-6 text-gray-900">Size in
                            litres</label>
                        <div class="relative mt-2 shadow-sm">
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="description" name="description" autocomplete="description" rows="3"
                                placeholder="Write a few sentences about your product (Optional)"
