  ...
  <div class="pt-6">
    ...
    <div class="mx-auto mt-6 max-w-md sm:px-6 lg:px-8">
      <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
        <img src="{{ $product->image ? asset('storage/'.$product->image) : asset('/images/small-logo.png') }}" alt="{{ $product->name }}" alt="{{ $product->name }}" class="h-full w-full object-cover object-center">
      </div>
    </div>
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
      ...
      <div class="mt-4 lg:row-span-3 lg:mt-0">
        ...
        <div class="mt-4 p-2 border-2 border-indigo-950 rounded-md">
            <a class="flex space-x-2" href="{{ route('product.edit', [
        ...
        <div class="mt-10">
          ...
          <div class="mt-4">
            <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
              <li class="text-gray-600"><span class="text-gray-700">Brand: </span> {{ $product->brand }}</li>
              <li class="text-gray-600"><span class="text-gray-700">Country: </span> {{ $product->country }}</li>
              <li class="text-gray-600"><span class="text-gray-700">Size: </span> {{ $product->size }}</li>
              <li class="text-gray-600"><span class="text-gray-700">Alcohol ABV: </span> {{ $product->alcohol_vlm }}</li>
              <li class="text-gray-600"><span class="text-gray-700">Stock: </span> {{ $product->stock }}</li>
            </ul>
          </div>
        </div>
      </div>
