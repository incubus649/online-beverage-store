                ...
                <div class="fixed inset-0 z-40 flex">
                    <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform"
                        ...
                        <form class="mt-4 border-t border-gray-200">
                            @csrf
                            <x-product-filter-mobile :filters="$brands" filterName="brand" filterTitle="Brand"
                                attribute="" />
                            <x-product-filter-mobile :filters="$countries" filterName="country" filterTitle="Country"
                                attribute="" />
                            <x-product-filter-mobile :filters="$sizes" filterName="size" filterTitle="Size"
                                attribute="L" />
                            <x-product-filter-mobile :filters="$alcohol_vlms" filterName="alcohol_vlm" filterTitle="Alcohol volume"
                                attribute="%" />
                        </form>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                        ...
                        <div id="product-filters">
                            <form id="product-filter-form" class="hidden lg:block" method="GET">
                                ...
                                <x-product-filter :filters="$countries" filterName="country" filterTitle="Country"
                                    attribute="" />
                                <x-product-filter :filters="$sizes" filterName="size" filterTitle="Size" attribute="L" />
                                <x-product-filter :filters="$alcohol_vlms" filterName="alcohol_vlm" filterTitle="Alcohol volume"
                                    attribute="%" />
                            </form>
                        </div>
