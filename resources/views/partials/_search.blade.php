    ...
    <div class="max-w-full md:p-8">
        <div class="relative rounded-sm shadow-sm">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center">
                <button id="submit" class="h-full border-0 md:text-md md:font-bold text-white bg-black py-0 pl-4 pr-6 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                    Search
                </button>
            </div>
        </div>
