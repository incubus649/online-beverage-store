...
<div class="group hover:drop-shadow-md">
    ...
    <div class="flex text-center font-bold opacity-0 group-hover:opacity-100">
        <a id="btn-cart" class="inline-flex justify-center gap-4 flex-1 w-1/2 rounded-sm mt-2 mr-2 p-2 text-white bg-black" href="#">
        ...
        <a id="btn-save" class="shrink inline-block w-1/6 mt-2 pb-0 p-2 text-white" href="#">
