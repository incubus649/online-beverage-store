...
@section('content')
    ...
    <div class="mx-auto max-w-7xl pb-8">
        <a href="{{ route('listings') }}">
            <img class="object-fit shadow-lg hover:shadow-xl h-72 w-full object-cover object-center rounded-xl"
                src="{{ asset('images/catalogue-image.png') }}" alt="Check out our catalogue">
        </a>
    </div>
